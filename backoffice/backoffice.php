...
$objTemplate->set_file(array(
	...
	"PAGINA" => TEMPLATES_DIR . "backoffice.html",
	"FOOTER" => TEMPLATES_DIR . "footer.html"
));

/* Muestro los items del Menu a los que el usuario tiene acceso y el encabezado de la pagina */
initBackofficeMenu();
setBackofficeMenu();
setBackofficeEncabezado("Bienvenido al Panel de Administración de la $strNombreEmpresa", false, "Desde esta plataforma puede administrar todo lo referente al evento.");
