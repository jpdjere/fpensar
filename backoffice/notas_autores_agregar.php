...
$objTemplate->set_file(array(
	...
	"PAGINA" => TEMPLATES_DIR . "notas_autores_agregar.html",
	"PAGINADOR" => TEMPLATES_DIR . "paginador.html",
	"OPCIONES" => TEMPLATES_DIR . "opciones.html",
	"FOOTER" => TEMPLATES_DIR . "footer.html"
));

if (checkReferer("notas_autores_agregar.php") && $_POST){
	...
	if ($objNotas->insertAutor($strAutor, $strImagen, $strImagenAnterior, $blnHabilitado))
		redirect("notas_autores_detalle.php?codAutor=" . $objNotas->intAutor);
	else{
