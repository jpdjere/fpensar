...
$objTemplate->set_file(array(
	...
	"PAGINA" => TEMPLATES_DIR . "cursos_mensaje_modificar.html",
	"PAGINADOR" => TEMPLATES_DIR . "paginador.html",
	"OPCIONES" => TEMPLATES_DIR . "opciones.html",
	"FOOTER" => TEMPLATES_DIR . "footer.html"
));

if (checkReferer("cursos_mensaje_modificar.php") && $_POST){
	...
	/* Inserto Curso */
	$objCursos = new clsCursos();
	if ($objCursos->updateCursoMensaje($strTexto)){
		redirect("cursos_mensaje.php");
	}else{
