...
class clsUsuarios {
	...
	function chequearUsuario($strUsuario, $strContrasenia, $strContraseniaConfirmacion, $intPerfil, 
							$strNombre, $strApellido, $strDescripcion, $strEmail, $blnNuevoUsuario){
	...
	function insertUsuario($strUsuario, $strContrasenia, $strContraseniaConfirmacion, $intPerfil, $strNombre, $strApellido, $strDescripcion, $strEmail, $blnEstado){

		$this->chequearUsuario($strUsuario, $strContrasenia, $strContraseniaConfirmacion, $intPerfil, $strNombre, $strApellido, $strDescripcion, $strEmail, true);
	...
	function updateContrasenia($strUsuario, $strContrasenia, $strContraseniaConfirmacion){
		...
		$this->errorContrasenia = $objCheck->arrErrors["strContrasenia"];
		$this->errorContraseniaConfirmacion = $objCheck->arrErrors["strContraseniaConfirmacion"];
